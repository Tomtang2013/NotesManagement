...
<div id="pr_login_page" class="pr_page">
    ...
    <?php if ($page['slide_image']): ?>
        <?php print render($page['slide_image']); ?>
    <?php endif; ?>

    <div id="pr_login_content" class="pr_content">
        <div id="pr_login_content_left" class="pr_content_left">
            <?php if ($page['user_login']): ?>
                <div id="pr_login" class="pr_login"><?php print render($page['user_login']); ?></div>
            <?php endif; ?>
        </div>
        <div id="pr_login_content_right" class="pr_content_right">
            <div id="main_content" class="main_content"></div>
        </div>
    </div>
    <div id="pr_login_footer" class="pr_footer">
