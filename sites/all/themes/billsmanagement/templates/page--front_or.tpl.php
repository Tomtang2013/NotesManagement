...
<div id="wrap">
  ...
  <?php print render($page['header']); ?>
    ...
    <?php if (theme_get_setting('slideshow_display','performancereview')): ?>
    <?php 
    $url1 = theme_get_setting('slide1_url','performancereview');
    $url2 = theme_get_setting('slide2_url','performancereview');
    $url3 = theme_get_setting('slide3_url','performancereview');
    ?>
      <div id="slider">
        <div class="main_view">
            <div class="window">
                <div class="image_reel">
                    <a href="<?php print url($url1); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'performancereview') . '/images/slide-image-3.jpg'; ?>"></a>
                    <a href="<?php print url($url2); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'performancereview') . '/images/slide-image-2.jpg'; ?>"></a>
                    <a href="<?php print url($url3); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'performancereview') . '/images/slide-image-1.jpg'; ?>"></a>
                </div>
                <div class="descriptions">
                    <div class="desc" style="display: none;"><?php print theme_get_setting('slide1_desc','performancereview'); ?></div>
                    <div class="desc" style="display: none;"><?php print theme_get_setting('slide2_desc','performancereview'); ?></div>
                    <div class="desc" style="display: none;"><?php print theme_get_setting('slide3_desc','performancereview'); ?></div>
                </div>
            </div>
